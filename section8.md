...
- :warning: 이미 Metamask를 사용하셨던분이거나 Opensea를 이용해 보신분들은 강의 내용과 조금 다른 스텝을 만날수 있습니다. 

- :warning: 강의자료를 만드는 과정에서 여러번 테스트를 진행하면서 처음 진행하시는분과 다른 스텝이 될수도 있습니다.

- :smiley: 하지만 어떤 화면이 나오시던지 예나 다음, 수락등의 긍정적인 버턴을 누르시면 문제 없이 넘어가실수 있습니다. 
